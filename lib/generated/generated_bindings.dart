...
final class libusb_config_descriptor extends ffi.Struct {
  ...
  external ffi.Pointer<libusb_interface> interface$;
...
final class libusb_iso_packet_descriptor extends ffi.Struct {
  ...
  libusb_transfer_status get status =>
      libusb_transfer_status.fromValue(statusAsInt);
}
...
typedef libusb_transfer_cb_fnFunction = ffi.Void Function(
    ffi.Pointer<libusb_transfer> transfer);
typedef Dartlibusb_transfer_cb_fnFunction = void Function(
    ffi.Pointer<libusb_transfer> transfer);
...
/// notified about.
typedef libusb_transfer_cb_fn
    = ffi.Pointer<ffi.NativeFunction<libusb_transfer_cb_fnFunction>>;
...
final class libusb_init_option extends ffi.Struct {
  /// Which option to set
  @ffi.UnsignedInt()
  external int optionAsInt;

  libusb_option get option => libusb_option.fromValue(optionAsInt);
